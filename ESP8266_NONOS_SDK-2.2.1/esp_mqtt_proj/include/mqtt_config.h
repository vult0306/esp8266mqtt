...
#define MQTT_HOST            "m11.cloudmqtt.com"//"i-garden.ddns.net" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
#define MQTT_PORT            18695//1883    // the listening port of your MQTT server or MQTT broker
...
/* default value, have to change this value to start scheduling */
#define SOD 0600
#define EOD 2400
#define DUR 1
#define GAP 1
